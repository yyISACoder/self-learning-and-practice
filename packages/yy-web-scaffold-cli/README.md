...
1. `npm install yy-web-scaffold-cli -g` 或 `yarn global add yy-web-scaffold-cli`
...
8. 集成了 **vue-router**
9. 集成 **axios**
10. 集成 lint-staged、husky、commitlint、eslint、prettier 工具链，用于规范代码风格与提高代码质量
...
7. 支持 **typescript**
8. 集成了 **vue-router**
9. 利用 **vuex-module-decorators** 集成了 vuex
10. 集成 **axios**
11. 集成 lint-staged、husky、commitlint、eslint、prettier 工具链，用于规范代码风格与提高代码质量
...
8. 集成 **axios**
9. 集成 lint-staged、husky、commitlint、eslint、prettier 工具链，用于规范代码风格与提高代码质量
